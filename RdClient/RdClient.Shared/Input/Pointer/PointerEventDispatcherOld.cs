...
{
    public class PointerEventDispatcherOld : IPointerEventConsumerOld
    {
        ...
        public PointerEventDispatcherOld(ITimer timer, IPointerManipulator manipulator, IRenderingPanel panel)
        {
