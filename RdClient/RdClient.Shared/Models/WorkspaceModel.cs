namespace RdClient.Shared.Models
{
    ...
    public abstract class WorkspaceModel<TWorkspaceData> : SerializableCompositionModel where TWorkspaceData : INotifyPropertyChanged
    {
        ...
        protected WorkspaceModel(IStorageFolder folder, IModelSerializer modelSerializer)
        {
            _folder = folder;
