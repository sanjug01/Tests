...
namespace RdClient.Shared.Test.Input.Mouse
{
    ...
    public class PointerModeTests : PointerInputTestsBase
    {
        ...
        // ============== Zoom tests broken by a parallel test refactoring - need separate base class ================
        // =============== TODO: TFS Task 1833480
        //[TestMethod]
        //public void PointerModel_ShouldVZoomIn()
        //{
        //    PointerManipulator.Expect("SendPinchAndZoom", new List<object> { 0.0, 20.0, 40.0, 20.0 }, null);
        ...
        //{
        //    PointerManipulator.Expect("SendPinchAndZoom", new List<object> { 20.0, 0.0, 20.0, 40.0 }, null);
        //    ConsumeEventsHelper(new PointerEvent[] { 
        //        new PointerEvent(new Point(10.0, 0.0), false, new Point(0.0, 0.0), true, false, PointerType.Touch, 3),
        ...
        //{
        //    PointerManipulator.Expect("SendPinchAndZoom", new List<object> { 20.0, 40.0, null, null }, null);
        //    ConsumeEventsHelper(new PointerEvent[] { 
        //        new PointerEvent(new Point(0.0, 0.0), false, new Point(0.0, 0.0), true, false, PointerType.Touch, 3),
