...
namespace RdClient.Shared.Test.Model
{
    ...
    public abstract class DataModelTests
    {
        ...
        public void TestSetup()
        {
            ...
            Mock.DataStorage mockStorage = new Mock.DataStorage();
            _expectedDesktops = _testData.NewSmallListOfDesktops();
            _expectedCreds = _testData.NewSmallListOfCredentials();
            mockStorage.Expect("LoadDesktops", new List<object>() { }, _expectedDesktops);
            mockStorage.Expect("LoadCredentials", new List<object>() { }, _expectedCreds);
            _dataModel = GetDataModel(mockStorage);
