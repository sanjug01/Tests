...
export COMMON_LANG_FLAGS=" ${ARCH_FLAGS} -fpie -fpic -ffunction-sections -funwind-tables -fdata-sections -fvisibility=hidden -D_FORTIFY_SOURCE=2 -fstack-protector-all -fno-strict-aliasing -finline-limit=64 -Os -g0 -DNDEBUG -DOPENSSL_NO_HEARTBEATS "
