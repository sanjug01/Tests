...
export ARCH_LINK=
export COMMON_LANG_FLAGS=" ${ARCH_FLAGS} -fpic -fpie -fdata-sections -ffunction-sections -fvisibility=hidden -D_FORTIFY_SOURCE=2 -funwind-tables -fstack-protector-all -fno-strict-aliasing -finline-limit=64 -Os -g0 -DNDEBUG -DOPENSSL_NO_HEARTBEATS "
